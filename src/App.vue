<template>
  <div id="app">
    ...
    <div class="row">
      ...
      <do-button type="primary" :loading="isLoading" @click="isLoading = !isLoading">主要按钮</do-button>
      <do-button type="error" :loading="isLoading" @click="isLoading = !isLoading">警告按钮</do-button>
    </div>
    <h2>倒计时</h2>
    <div class="row">
